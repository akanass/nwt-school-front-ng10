...
__decorate([
    swagger_1.ApiPropertyOptional({ name: 'firstname', description: 'Firstname', example: 'Mclaughlin' }),
...
__decorate([
    swagger_1.ApiPropertyOptional({ name: 'lastname', description: 'Lastname', example: 'Cochran' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty(),
    __metadata("design:type", String)
...
__decorate([
    swagger_1.ApiPropertyOptional({ name: 'entity', description: 'Entity where person works', example: 'UTARA' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    class_validator_1.IsNotEmpty(),
    __metadata("design:type", String)
...
__decorate([
    swagger_1.ApiPropertyOptional({ name: 'email', description: 'Email', example: 'Mclaughlin.Cochran@undefined.com' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsEmail(),
    __metadata("design:type", String)
], UpdatePersonDto.prototype, "email", void 0);
__decorate([
    swagger_1.ApiPropertyOptional({ name: 'phone', description: 'Phone', example: '+33600000000', pattern: '/^(\+\d{11})$/' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsPhoneNumber('FR'),
    __metadata("design:type", String)
], UpdatePersonDto.prototype, "phone", void 0);
__decorate([
    swagger_1.ApiPropertyOptional({ name: 'address', description: 'Address' }),
    class_validator_1.IsOptional(),
...
__decorate([
    swagger_1.ApiPropertyOptional({ name: 'isManager', description: 'Flag to know if this person is a manager', example: false }),
    class_validator_1.IsOptional(),
