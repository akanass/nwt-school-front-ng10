...
__decorate([
    ...
    swagger_1.ApiBody({ description: 'Payload to create a new person', type: create_person_dto_1.CreatePersonDto }),
    common_1.Post(),
...
__decorate([
    ...
    swagger_1.ApiBody({ description: 'Payload to update a person', type: update_person_dto_1.UpdatePersonDto }),
    common_1.Put(':id'),
